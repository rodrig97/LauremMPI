...
callback_fns.mnuescala_nuevo = function () {
  dijit
    .byId("dv_ppaa_contenedor")
    .resize({ w: "1270", h: 400, l: 0, t: 0 }, { w: 1000, h: 400 });
};
...
callback_fns.mnuescala_registro = function () {
  ...
  dijit
    .byId("escalaregistro_container")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });
  //dijit.byId('legajoregistro_container').resize({w: dims.w ,h: (dims.h - 70 -desc_altura), l: 0, t:0});
  ...
  require([
    ...
    //console.log(dojo.byId("dvapersonalregistrado_table"));
    if (dojo.byId("dvapersonalregistrado_table") != null) {
      if (window.escalafon_grid === null || window.escalafon_grid === undefined)
      ...
      Persona.Ui.Grids.trabajadores = new (declare([
        Grid,
        Selection,
        Keyboard,
      ]))(
    ...
    //alert(dojo.byId('legajopersonalregistrado_table'))
  });
};
callback_fns.mnulegajo = function () {
  ...
  function default_index() {
    // $("#table-id  tbody tr:eq(0)").prepend("<th> ID </th>");
...
callback_fns.mnuplanillas_conceptos_gestionar = function () {
  try {
    require([
      ...
      Conceptos._M.store_conceptos_variables = new Cache(
        restStore,
        memoryStore
      );
      Conceptos._M.store_conceptos_variables.query({
        fortipo: "71c30216a4d1a1d0c23b7158a709bc23",
      });
    });
    ...
    console.log(
      error.message
        ? "Error: " + error.message
        : "Error: main.js/mnuplanillas_conceptos_gestionar " + error
    );
  }
};
...
callback_fns.mnutrabajador_gestiondatos = function () {
  ...
  dojo.connect(dijit.byId("selgd_modo"), "onChange", function (evt) {
    if (
      Trabajadores.Cache.trabajador_gestion_datos != null &&
      Trabajadores.Cache.trabajador_gestion_datos != "" &&
      Trabajadores.Cache.trabajador_gestion_datos != undefined
    ) {
      if (dijit.byId("selgd_modo").get("value") == "1") {
        Trabajadores._V.gestionar_datos_rapida.send({
          trabajador: Trabajadores.Cache.trabajador_gestion_datos,
        });
      } else {
        Trabajadores._V.gestionar_datos.send({
          trabajador: Trabajadores.Cache.trabajador_gestion_datos,
        });
      }
    }
  ...
  require([
    ...
    if (dojo.byId("dvtgd_trabajadores") != null) {
      ...
      Planillas.Ui.Grids.trabajadores_gestionardata = new (declare([
        Grid,
        Selection,
        Keyboard,
      ]))(
...
callback_fns.mnu_planilla_reportes = function () {
  ...
  dijit
    .byId("planilla_reporter_container")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });
  ...
  require([
    ...
    if (dojo.byId("dv_reportes_filtroplanilla") != null) {
      ...
      var store_planillas = Observable(
        Cache(
          JsonRest({
...
callback_fns.actualizacion_de_datos = function () {
  ...
  dijit
    .byId("dvactualizaciondatos_container")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });
...
callback_fns.explorar_por_fechas = function () {
  ...
  dijit
    .byId("dvexplorarfechas_container")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });

  dojo.connect(
    dijit.byId("dvexplorarfechas_tipoview"),
    "onChange",
    function () {
...
callback_fns.gestionar_usuarios = function () {
  ...
  dijit
    .byId("gestionusuarios_container")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });
...
callback_fns.gestionar_historial_laboral = function () {
  ...
  dijit
    .byId("viewcontratos_container")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });

  dojo.connect(
    dijit.byId("selcaontratos_tipobusqueda_modo"),
    "onChange",
    function (evt) {
  ...
  dojo.connect(
    dijit.byId("selcontratos_fecha_sel1"),
    "onChange",
    function (evt) {
      var tipo = this.get("value");
  ...
  dojo.connect(
    dijit.byId("selcontratos_yqterminen"),
    "onChange",
    function (evt) {
      var tipo = this.get("value");
  ...
  dojo.connect(
    dijit.byId("selcontratos_fecha_sel2"),
    "onChange",
    function (evt) {
      //console.log(this.get('value'));
  ...
  dojo.connect(
    dijit.byId("selcaontratos_tipobusqueda_tipo"),
    "onChange",
    function (evt) {
      //onsole.log(this.get('value'));
...
callback_fns.quinta_categoria = function () {
  ...
  require([
    ...
    if (dojo.byId("impuestoquinta_filtrotrabajadores") != null) {
      ...
      Planillas.Ui.Grids.quinta_categoria = new (declare([
        Grid,
        Selection,
        Keyboard,
      ]))(
...
callback_fns.sunat = function () {
  ...
  require([
    ...
    if (dojo.byId("table_sunatbajas") != null) {
      ...
      Planillas.Ui.Grids.sunat_bajas = new (declare([
        Grid,
        Selection,
        Keyboard,
      ]))(
    ...
    if (dojo.byId("table_sunat_planillas_seleccionadas") != null) {
      ...
      var store_planillas = Observable(
        Cache(
          JsonRest({
            target:
              app.getUrl() + "planillas/registro_planillas/seleccionadas_sunat",
            idProperty: "id",
            sortParam: "oby",
            query: function (query, options) {
              var data = dojo.formToObject("form_sunat_declarar");
      ...
      Planillas.Ui.Grids.sunat_planillas_seleccionadas =
        new window.escalafon_grid(
          {
            /*  store: store_planillas,
                                                loadingMessage : 'Cargando',
                                                getBeforePut: true,
...
callback_fns.asistencias_explorar_obreros = function () {
  ...
  dijit
    .byId("asistencias_explorar_container")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });
  ...
  dojo.connect(
    dijit.byId("selexplorarasis_tipobusqueda"),
    "onChange",
    function (evt) {
      var tipobusqueda = dijit
        .byId("selexplorarasis_tipobusqueda")
        .get("value");

      if (tipobusqueda == "1") {
        // Regimen
        dojo.setStyle(
          dojo.byId("trexplorarasis_regimen"),
          "display",
          "table-row"
        );
        ...
        dojo.setStyle(
          dojo.byId("trexplorarasis_trabajador"),
          "display",
          "none"
        );
        dojo.setStyle(
          dojo.byId("trexplorarasis_mostraractivos"),
          "display",
          "table-row"
        );
        ...
        dojo.setStyle(
          dojo.byId("trexplorarasis_proyecto"),
          "display",
          "table-row"
        );
        dojo.setStyle(dojo.byId("trexplorarasis_area"), "display", "none");
...
callback_fns.asistencias_configuracion = function () {
  ...
  dijit
    .byId("dvasistencias_asistencia_config")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });
...
callback_fns.permisos_aprobacion = function () {
  ...
  dijit
    .byId("permisoaprobacion_container")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });
  ...
  require([
    ...
    if (dojo.byId("tablapermisos_panel") != null) {
      ...
      Planillas.Ui.Grids.permisos_panel = new (declare([
        Grid,
        Selection,
        Keyboard,
      ]))(
    ...
    dijit
      .byId("selspermisoaprobacion_solicita")
      .set("store", Persona.Stores.individuos);
  });
};
...
callback_fns.quintacategoria_configuracion = function () {
  ...
  dijit
    .byId("dvquintacategoria_configuracion")
    .resize({ w: dims.w, h: dims.h - 70 - desc_altura, l: 0, t: 0 });
...
callback_fns.registro_licencias = function () {
  ...
  require([
    ...
    if (dojo.byId("tablalicencias_panel_registradas") != null) {
      ...
      EstadoDia.Ui.Grids.licencias_registradas = new (declare([
        Grid,
        Selection,
        Keyboard,
      ]))(
  ...
  dojo.connect(dijit.byId("selRLTipoPeriodo"), "onChange", function (evt) {
    ...
    if (v == "anio") {
      ...
      dojo.setStyle(
        dojo.byId("divPeriodoIntervaloFechas"),
        "display",
        "inline-block"
      );
    }
  ...
  dojo.connect(
    dijit.byId("buscarPorTrabajadorTipoTrabajador"),
    "onChange",
    function (evt) {
      ...
      if (v == "tipotrabajador") {
        dojo.setStyle(
          dojo.byId("dvbuscarTipoTrabajador"),
          "display",
          "inline-block"
        );
      } else {
        dojo.setStyle(
          dojo.byId("dvbuscarTrabajador"),
          "display",
          "inline-block"
        );
      }
  ...
  dojo.connect(dijit.byId("selxf_agruparpor"), "onChange", function (evt) {
    ...
    dojo.setStyle(
      dojo.byId("dvregistrolicenciasTotalAcumulado"),
      "display",
      "none"
    );
...
callback_fns.mnuasistencia_especificarlugar = function () {
  ...
  require([
    ...
    if (dojo.byId("dvespecificarlugar_de_trabajo") != null) {
      ...
      Planillas.Ui.Grids.especificar_lugar_trabajo = new (declare([
        Grid,
        Selection,
        Keyboard,
      ]))(
...
var MENU_MAP = [
  {
    dom_id: "mnuescala_registro",
    url: app.url + "escalafon/ui_personal_registrado",
    data: "",
    callback: callback_fns.mnuescala_registro,
  },
  {
    dom_id: "mnuvc_gestionar",
    url: app.url + "planillas/ui_gestionar_conceptos",
    data: "",
    callback: callback_fns.mnuplanillas_conceptos_gestionar,
  },
  {
    dom_id: "mnudt_gestionar",
    url: app.url + "trabajadores/gestionar_datos",
    data: "",
    callback: callback_fns.mnutrabajador_gestiondatos,
  },
  {
    dom_id: "mnupla_registrohojas",
    url: app.url + "asistencias/ver_hojas",
    data: "",
    callback: function () {},
  },
  {
    dom_id: "mnupla_reportes",
    url: app.url + "exportar/exportacion_y_reportes",
    data: "",
    callback: callback_fns.mnu_planilla_reportes,
  },
  {
    dom_id: "mnuescalafon_actdata",
    url: app.url + "escalafon/actualizacion_de_datos",
    data: "",
    callback: callback_fns.actualizacion_de_datos,
  },
  {
    dom_id: "mnuescala_explorarfechas",
    url: app.url + "escalafon/explorar_por_fechas",
    data: "",
    callback: callback_fns.explorar_por_fechas,
  },
  {
    dom_id: "mnugtp_gestionar",
    url: app.url + "tipoplanillas/gestionar",
    data: "",
    callback: callback_fns.gestionar_tipo_planilla,
  },
  {
    dom_id: "mnuescala_gestion_sl",
    url: app.url + "escalafon/gestion_historial_laboral",
    data: "",
    callback: callback_fns.gestionar_historial_laboral,
  },
  {
    dom_id: "mnusistema_usuarios",
    url: app.url + "usuarios/gestionar_usuarios",
    data: "",
    callback: callback_fns.gestionar_usuarios,
  },
  {
    dom_id: "mnuxls_importar_trabajadores",
    url: app.url + "importacionxls/panel_importar_trabajadores",
    data: "",
    callback: callback_fns.importar_trabajadores_panel,
  },
  {
    dom_id: "mnuimpuesto_quinta",
    url: app.url + "impuestos/quinta_categoria",
    data: "",
    callback: callback_fns.quinta_categoria,
  },
  {
    dom_id: "mnuimpuesto_afp",
    url: app.url + "impuestos/afp",
    data: "",
    callback: callback_fns.afp,
  },
  {
    dom_id: "mnuimpuesto_sunat",
    url: app.url + "impuestos/sunat",
    data: "",
    callback: callback_fns.sunat,
  },
  {
    dom_id: "mnuasistencia_explorar",
    url: app.url + "asistencias/explorar_obreros",
    data: "",
    callback: callback_fns.asistencias_explorar_obreros,
  },
  {
    dom_id: "mnuasistencia_explorar_emple",
    url: app.url + "asistencias/explorar_empleados",
    data: "",
    callback: callback_fns.asistencias_explorar_empleados,
  },
  {
    dom_id: "mnuasistencia_config",
    url: app.url + "asistencias/configuracion",
    data: "",
    callback: callback_fns.asistencias_configuracion,
  },
  {
    dom_id: "mnupermisos_missolicitudes",
    url: app.url + "permisos/mis_permisos",
    data: "",
    callback: callback_fns.mis_papeletas_salida,
  },
  {
    dom_id: "mnuquinta_configuracion",
    url: app.url + "quintacategoriarouter/configuracion",
    data: "",
    callback: callback_fns.quintacategoria_configuracion,
  },
  {
    dom_id: "mnuquinta_modulo",
    url: app.url + "quintacategoriarouter/registro_retenciones",
    data: "",
    callback: callback_fns.quinta_registro_retenciones,
  },
  {
    dom_id: "mnupermisos_aprobacion",
    url: app.url + "permisos/aprobacion",
    data: "",
    callback: callback_fns.permisos_aprobacion,
  },
  {
    dom_id: "mnuasistencia_registrodiario",
    url: app.url + "asistencias/registro_diario",
    data: "",
    callback: callback_fns.registro_diario,
  },
  {
    dom_id: "mnuasistencias_reglicencias",
    url: app.url + "asistencias/registro_licencias",
    data: "",
    callback: callback_fns.registro_licencias,
  },
  {
    dom_id: "mnucontabilidad_main",
    url: app.url + "contabilidadcontroller/contabilizar_planillas",
    data: "",
    callback: callback_fns.mnu_contabilidad_inicio,
  },
  {
    dom_id: "mnuasistencia_especificarlugar",
    url: app.url + "asistencias/especificar_lugar_trabajo",
    data: "",
    callback: callback_fns.mnuasistencia_especificarlugar,
  },
  {
    dom_id: "mnulegajo",
    url: app.url + "escalafon/ui_legajo",
    data: "",
    callback: callback_fns.mnulegajo,
  },
...
dojo.ready(function () {
  ...
  dojo.forEach(MENU_MAP, function (mnu, ind) {
    if (dojo.byId(mnu.dom_id) != null) {
      dojo.connect(dojo.byId(mnu.dom_id), "onclick", function () {
        app.view_load(dojo.byId(mnu.dom_id), {
          view: mnu.url,
          fn: mnu.callback,
        });
      });
  ...
  if (dojo.byId("mnuplanilla_nueva") != null) {
    dojo.connect(
      dojo.byId("mnuplanilla_nueva"),
      "onclick",
      Planillas.Ui.mnunew_planilla_click
    );
  }
  ...
  if (dojo.byId("mnuplanilla_registro") != null) {
    // alert(Planillas);
    dojo.connect(
      dojo.byId("mnuplanilla_registro"),
      "onclick",
      Planillas.Ui.mnuregistro_planilla_click
    );
  }
  ...
  if (dojo.byId("mnuplanilla_boletaindividuales") != null) {
    dojo.connect(
      dojo.byId("mnuplanilla_boletaindividuales"),
      "onclick",
      function (e) {
  ...
  if (dojo.byId("mnuplanilla_reportedescuento") != null) {
    dojo.connect(
      dojo.byId("mnuplanilla_reportedescuento"),
      "onclick",
      function (e) {
  ...
  if (dojo.byId("mnusunat_verificacionpdt") != null) {
    dojo.connect(
      dojo.byId("mnusunat_verificacionpdt"),
      "onclick",
      function (e) {
  ...
  if (dojo.byId("mnasistencia_registrohojas") != null) {
    // alert(Planillas);
    dojo.connect(
      dojo.byId("mnasistencia_registrohojas"),
      "onclick",
      Asistencias.Ui.mnuregistro_asistencia_click
    );
  }
  ...
  if (dojo.byId("mnusistema_abouthis") != null) {
    ...
    dojo.connect(dojo.byId("mnusistema_abouthis"), "onclick", function () {
      acerca_de.load({});
    });
  }
