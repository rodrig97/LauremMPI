          ...
          table_comisiones : new Request({
               ...
               onRequest: function(){
                  ...
                  //  dojo.byId('').innerHTML = '<div class="loader_div1"> </div>';
                   dojo.setStyle( dojo.query('.table_loader', dojo.byId('dvcomision_table') )[0], 'display', 'block' );
                   dojo.setStyle( dojo.query('.table_data', dojo.byId('dvcomision_table') )[0], 'display', 'none' );
               ...
               onSuccess: function(responseText){
                   ...
                   dojo.setStyle( dojo.query('.table_loader', dojo.byId('dvcomision_table') )[0], 'display', 'none' );
                   dojo.setStyle(  table , 'display', 'block' );
                   
                   dojo.query('.table_data', dojo.byId('dvcomision_table') )[0].innerHTML = responseText;
...
/*
                  ...
                  if ( dijit.byId('chhis_actual') != null )
                  {
                      ...
                      dojo.connect( dijit.byId('chhis_actual'), 'onChange' , function(e){
                             ...
                             if(dijit.byId('chhis_actual').get('checked') )
                             {
                                dojo.setStyle(dojo.byId('dvtermino_contrato'), 'display', 'inline');      
                             }
                             else{
                  ...
                  if ( dijit.byId('chcarnet_presento') != null )
                  {
                      ...
                      dojo.connect( dijit.byId('chcarnet_presento'), 'onChange' , function(e){

                             if(dijit.byId('chcarnet_presento').get('checked') )
                             {
                                dojo.setStyle(dojo.byId('dv_carnetPresento'), 'display', 'inline');      
                             }
                             else{
                              
                                dojo.setStyle(dojo.byId('dv_carnetPresento'), 'display', 'none'); 
                             }
                  ...
                  if( dijit.byId('selhis_laboral') != null ){
                        ...
                        dojo.connect(dijit.byId('selhis_laboral'), 'onChange', function(){
                               ...
                               if(v!= 0){
                                   ...
                                   dojo.setStyle( dojo.byId('trhis_infosisgedo'), 'display','table-row');
                               ...
                               if( v == app._consts.sitlab_inversiones ){
                                ...
                                if( v == app._consts.sitlab_nombrados || v == app._consts.sitlab_contratados ){
                                ...
                                if(v == app._consts.sitlab_contratados || v == app._consts.sitlab_construccion ){
                                    //dojo.setStyle( dojo.byId('trhis_proy'), 'display','table-row');
                                }
                                ...
                                if(v == app._consts.sitlab_obrenombrados || v == app._consts.sitlab_obrecontratados  ){
                               ...
                               if(v == app._consts.sitlab_construccion ){
                                    ...
                                    dijit.byId('selhis_depe').set('value',app._consts.depe_ejecucion_proy);
                               ...
                               if(v == app._consts.sitlab_regidores ){
                                    ...
                                    dojo.setStyle( dojo.byId('trhis_depe'), 'display','table-row');
                                    dijit.byId('selhis_depe').set('value',app._consts.depe_regidores);
                                    dijit.byId('selhis_cargo').set('value',app._consts.cargo_regidor);
                                    dijit.byId('selhis_depe').set('readOnly',true);
                                    dijit.byId('selhis_cargo').set('readOnly',true);
                                }
         ...
         editar_situlaboral : new Laugo.View.Window({
             ...
             style : {
              ...
              onLoad: function(){
                  ...
                  if(dojo.query('.on_unload_window', this.wd_dialog.domNode )[0] != null)
                  {
                           
                      var msm = dojo.query('.on_unload_window', this.wd_dialog.domNode )[0].value;
                      app.alert(msm);
                      this.close();
                      return false;
                  }
                  ...
                  dojo.forEach(['calhisdesde','calhishasta','calhistermino'], function(cal,ind){
                  ...
                  var temp = function (){
                      ...
                      dijit.byId('calhistermino').constraints.min = dijit.byId('calhisdesde').get('value'); 
                        
                  }


                  dijit.byId('selhis_laboral').set('value', dojo.byId('hdhledit_tipo').value );
                  ...
                  parts= fecha.split('/');
                  fecha = new Date(parts[2], (parseInt(parts[1])-1), parseInt(parts[0]), 0,0,0);  
                  ...
                  dijit.byId('txthis_plaza').set('value', dojo.byId('hdhledit_plaza').value );
            
                  dijit.byId('txthis_documento').set('value', dojo.byId('hdhledit_doc').value );
            
                  dijit.byId('txthis_aut').set('value', dojo.byId('hdhledit_aut').value ); 
            
                  if( dojo.byId('hdhledit_depe').value != '0')  dijit.byId('selhis_depe').set('value', dojo.byId('hdhledit_depe').value ); 
            
                  if( dojo.byId('hdhledit_cargo').value != '0') dijit.byId('selhis_cargo').set('value', dojo.byId('hdhledit_cargo').value );

                  dijit.byId('dvhis_descripcion').set('value', dojo.byId('hdhledit_descripcion').value );   
        ...
        gestion_rapida_deconceptos : new Laugo.View.Window({
             ...
             style : {
              ...
              onLoad: function(){
                  ...
                  var conceptos = dojo.query('.ch_gestion_concepto'), estado = false;
        ...
        full_info_persona: new Laugo.View.Window({
             ...
             connect : 'escalafon/ui_full_info',
              ...
              { 
                  ...
                  if(dijit.byId('wd_newpersona_container') == null || dijit.byId('wd_newpersona_container') == undefined){

                     return false;
                  }
                   
                  dijit.byId('wd_newpersona_container').resize({w:830,h:450, l: 0, t:0},{w: 1000 ,h: 400});   
                  ...
                  { 
                      (function(){ 
                                ...
                                var f_depar_def = function(){
                                     ...
                                     if(nd!='' && nd!= null) dijit.byId('fip_departamento').set('value', nd );
                                }
                                
                                var f_prov_def =  function(){
                                     var nd = dojo.query('.provincia',data)[0];
                                     
                                     if(nd!='' && nd!= null) dijit.byId('fip_provincia').set('value', nd );
                                }
                                
                                var f_dis_def =  function(){
                                     var nd = dojo.query('.distrito',data)[0];
                                     
                                     if(nd!='' && nd!= null) dijit.byId('fip_distrito').set('value', nd );
                                }
                  ...
                  if(dojo.byId('table_academico_data') != null)
                  {
                      ...
                      var only_view_rows  = function(o_v){ // 
                       ...
                       if(dijit.byId('selAcademicoTiEst') != null ){
                            ...
                            dojo.connect(dijit.byId('selAcademicoTiEst'),'onChange', function(){
                  ...
                  if(dijit.byId('selfami_parentesco') != null)
                  {
                       ...
                       dojo.connect( dijit.byId('selfami_parentesco'), 'onChange' , function(e){

                              if(dijit.byId('selfami_parentesco').get('value') == '4' )
                              {
                                 dojo.setStyle(dojo.byId('trfami_estudiante'), 'display', 'table-row');      
                              }
                              else{
                               
                                 dojo.setStyle(dojo.byId('trfami_estudiante'), 'display', 'none');
                  ...
                  require(["dgrid/List", "dgrid/OnDemandGrid","dgrid/Selection", "dgrid/editor", "dgrid/Keyboard", "dgrid/extensions/Pagination", "dojo/_base/declare", "dojo/store/JsonRest", "dojo/store/Observable", "dojo/store/Cache", "dojo/store/Memory", "dojo/domReady!"], 
                          ...
                          window.escalafon_grid = (declare([Grid, Selection,Keyboard]));
                                   ...
                                   if(dojo.byId('dvhistorial_table') != null ){ 
                                            ...
                                            var store_historial_lab = Observable(Cache(JsonRest({
                                ...
                                if(dojo.byId('dvcomision_table') != null ){ 
                                        ...
                                        var store_comisiones = Observable(Cache(JsonRest({
                            ...
                            { 
                                        ...
                                        var store_vacaciones = Observable(Cache(JsonRest({
                                ...
                                if(dojo.byId('dvdescanso_table') != null ){ 
                                        ...
                                        var store_descansos = Observable(Cache(JsonRest({
                            ...
                            if(dojo.byId('dvlicencia_table') != null ){ 
                                        ...
                                        var store_licencias = Observable(Cache(JsonRest({
                            ...
                            if(dojo.byId('dvpermiso_table') != null ){ 
                                        ...
                                        var store_permisos = Observable(Cache(JsonRest({
                             ...
                             if(dojo.byId('dvfaltas_table') != null ){ 
                                        ...
                                        var store_faltar = Observable(Cache(JsonRest({
                              ...
                              if(dojo.byId('dvtardanza_table') != null ){ 
                                         ...
                                         var store_tardanza = Observable(Cache(JsonRest({
                              ...
                              if(dojo.byId('dvfamiliar_table') != null ){ 
                                            ...
                                            var store_familiares = Observable(Cache(JsonRest({
                                ...
                                if(dojo.byId('dvacademico_table') != null ){ 
                                            ...
                                            var store_academico = Observable(Cache(JsonRest({
      ...
      dojo.setStyle(dojo.byId('dv_files_buttonsubir'), 'display', 'none');
          dojo.setStyle(dojo.byId('dv_files_subir'), 'display', 'block');
            ...
            var myDialog = new dijit.Dialog({
                                    ...
                                    content:  '<div style="padding: 4px 4px 4px 4px;"> ' +data.error + '</div>',
                                    style: "width: 350px"
                                });
                     myDialog.show();
