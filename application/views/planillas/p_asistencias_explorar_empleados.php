<div id="dvViewName" class="dv_view_name">
     ...
     <table class="_tablepadding2" border="0">
         <tr> 
              ...
              <td>
                   Explorar registro de asistencia Empleados
              </td>
         </tr>
      </table>
</div>
                          ...
                          <div data-dojo-type="dijit.form.DropDownButton" >
                                     ...
                                     <div  data-dojo-type="dijit.TooltipDialog" data-dojo-props='title:"Parametros de busqueda"'>
                                           ...
                                           <form id="form_explorar_asistencias"  data-dojo-type="dijit.form.Form" action="exportar/asistencia_permisos_excel" method="post" target="_blank">   
                                                ...
                                                <input type="hidden" name="tipo_registro_asistencia" value="2"> 
                    ...
                    <!--    <td>   
                       ...
                       <td>   
                            ...
                            <select id="sel_asis_visualizar"  
                                    ...
                                    style="font-size:11px; width:170px;">
                                  
                                   <option value="1"> Estado del día </option>
                                   <option value="2"> Horas Contabilizadas </option>
                                   <option value="3"> Minutos Tardanzas </option> 
                                   <option value="8"> Minutos permiso descuento </option> 
                      ...
                      <td>
                             ...
                             <button  dojoType="dijit.form.Button" class="dojobtnfs_12" > 
                               ...
                               <button  dojoType="dijit.form.Button" class="dojobtnfs_12" > 
                                     ...
                                     ?>
                                        <label class="lbl10">  Registro de Licencias </label>
                                         <script type="dojo/method" event="onClick" args="evt">

                                                var data =  dojo.formToObject('form_explorar_asistencias'); 
                                               
                                                EstadoDia._V.incidencias_registradas.load(data);
                               ...
                               <button  dojoType="dijit.form.Button" class="dojobtnfs_12" > 
                                     <?PHP 
                                        $this->resources->getImage('application.png',array('width' => '14', 'height' => '14'));
                                     ?>
                                        <label class="lbl10">  Registro de Permisos  </label>
                                         <script type="dojo/method" event="onClick" args="evt">
                                                 
                                                var data =  dojo.formToObject('form_explorar_asistencias'); 
                                                
                                                Permisos._V.permisos_registrados.load(data);
                            ...
                            <div data-dojo-type="dijit.form.DropDownButton" >
                                 ...
                                 <span class="sp11">
                                  ...
                                  <div  data-dojo-type="dijit.TooltipDialog" data-dojo-props='title:"Operaciones"'>
                                         ...
                                         <tr>
                                           <td>
                                                <button  dojoType="dijit.form.Button" class="dojobtnfs_12" > 
                                                      <?PHP 
                                                         $this->resources->getImage('application.png',array('width' => '14', 'height' => '14'));
                                                      ?>
                                                         <label class="lbl10"> Actualizar dias sin cierre </label>
                                                          <script type="dojo/method" event="onClick" args="evt">
                                                                  
                                                                 var data =  dojo.formToObject('form_explorar_asistencias'); 
                                                                 
                                                                 Asistencias._V.actualizacion_de_fechas_sincierre.load(data);
                                           ...
                                           <td> 
                                                <button  dojoType="dijit.form.Button" class="dojobtnfs_12" > 
                                                      ...
                                                      ?>
                                                         <label class="lbl10"> Biometrico </label>
                                                          <script type="dojo/method" event="onClick" args="evt">
                                                                  
                                                                 var data =  dojo.formToObject('form_explorar_asistencias'); 
                                                                
                                                                 Biometrico._V.biometrico_panel.load({});
                             ...
                             <div data-dojo-type="dijit.form.DropDownButton" >
                                  ...
                                  <span class="sp11">
                                   ...
                                   <div  data-dojo-type="dijit.TooltipDialog" data-dojo-props='title:"Imprimir"'>
                                            ...
                                            <td>
                                                 ...
                                                 <button  dojoType="dijit.form.Button" class="dojobtnfs_12" > 
                                                       <?PHP 
                                                          $this->resources->getImage('printer.png',array('width' => '14', 'height' => '14'));
                                                       ?>
                                                          <label class="lbl10">  Reporte de asistencias   </label>
                                                           <script type="dojo/method" event="onClick" args="evt">

                                                                  var data =  dojo.formToObject('form_explorar_asistencias'); 

                                                                  document.getElementById('form_explorar_asistencias').action = 'exportar/asistencia_excel';
                                                                  
                                                                  dojo.byId('form_explorar_asistencias').submit();
                                            ...
                                            <td>
                                               ...
                                               <button  dojoType="dijit.form.Button" class="dojobtnfs_12" > 
                                                     <?PHP 
                                                        $this->resources->getImage('printer.png',array('width' => '14', 'height' => '14'));
                                                     ?>
                                                        <label class="lbl10"> Reporte de permisos </label>
                                                         <script type="dojo/method" event="onClick" args="evt">

                                                                var data =  dojo.formToObject('form_explorar_asistencias'); 
 
                                                                document.getElementById('form_explorar_asistencias').action = 'exportar/asistencia_permisos_excel';
