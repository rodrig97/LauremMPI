...
<div class="dvcontainer_calendar"> 
 ...
 <input id="hdcalendariotipo" type="hidden" value="1" />
 <input id="hdaccesoescalafon" type="hidden" value="<?PHP echo $acceso_escalafon; ?>" />
...
/*    echo " <tr> 
    	    <td colspan='33'> probando division </td>
    	 </tr> ";*/
		 ...
		 {		 	
				...
				$trabajador_fila = trim($reg['indice']);
		 		...
		 		echo "<td class='td_numeracion'>".$counter_trabajadores."</td> 
 			 	...
 			 	if($hoja_info['estado_id'] == HOJAASIS_ESTADO_ELABORAR &&  $this->user->has_key('ASISTENCIAS_SUPERVISOR') == FALSE )
 			 	{	

 			 		if($reg['registros_importados'] == '0' || $reg['registros_importados'] == '' )
 			 		{

	 					echo " <span class='spdetcal_delete'>[X]</span>  ";

	 					if($hoja_info['hoa_tienecategorias'] == '1')
	 					{
	 						echo " <span class='spdetcal_cambiarcategoria'>[C]</span>  ";
	 					}

 					}
 			 	}	

 	        	echo     "<span class='spnombretrabajador'>".$reg['trabajador']." </span> 

 	        			   <div style='margin:4px 0px 0px 4px'> DNI: ".$reg['dni'];
		 		...
		 		$tooltip.=" </table>";
 				 ...
 				 echo     " > ";
    						  ...
    						  else if (  $params['modo_ver'] == MODOVERCALENDARIO_MARCACION4 )
    						  {
 				        	  ...
 				        	  if($biometrico_id != '' && $biometrico_id !='0' )
 				 	     	  {
 				 	     	  		echo '.';
 				 	     	  } 
