    ...
    <table class="_tablepadding4">
        <tr>  
                <td>
                  ...
                  <td> 
                     <span class="sp12b"> <?PHP echo ( $reniec['nombres'] == '' ? '[NO SE PUDO OBTENER INFORMACIÓN DE LA RENIEC]' : '' ); ?></span>
                  </td>
        </tr>
    </table>
      <?PHP } ?>
             ...
             <tr class="row_form">
               ...
               <tr class="row_form">
                 <td> <span class="sp12b">Direcci&oacute;n 1 </span></td>
                  <td>:</td>
                  <td> 
                      <input id="fip_direccion1"  name="direccion1" type="text" data-dojo-type="dijit.form.TextBox" data-dojo-props="maxlength:100" class="formelement-250-12" value="<?php echo $reniec['direccion']; ?>" />
                  </td>
             </tr>
             <tr class="row_form">
