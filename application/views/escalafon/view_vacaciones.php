<div class="window_container">
    ...
    <div id="dvViewName" class="dv_view_name">
        Detalle del registro de vacaciones
    </div>
    ...
    <div class="dv_form_bceleste"> 
        ...
        <div> 
           <input class="data" type="hidden" value="vacaciones-<?PHP echo trim($info['perva_id']); ?>" />   
           ...
           <button class="btnproac_regacti" dojoType="dijit.form.Button" class="dojobtnfs_12" > 
                ...
                <script type="dojo/method" event="onClick" args="evt">
                     Persona.Ui.btn_viewadjuntar_click(this,evt,'view_vacaciones');
                </script>
           </button>
        ...
        <table class="_tablepadding4" width="100%">
            ...
            <tr height="30" class="row_static_form">
             ...
             <tr height="30" class="row_static_form">
               ...
               <td>
                     <span class="sp12"> <?PHP  echo trim($info['perva_documento']); ?>  
                </td>
            </tr>
            ...
            <tr height="30" class="row_static_form">
               ...
               <td>
                     <span class="sp12"> <?PHP  echo _get_date_pg(trim($info['perva_fechaini'])); ?>   </span>
                </td>
            </tr>
            <tr height="30" class="row_static_form">
                <td>
               ...
               <td>
                     <span class="sp12"> <?PHP  echo _get_date_pg(trim($info['perva_fechafin'])); ?>   </span>
                </td>
            </tr>
            ...
            <tr height="30" class="row_static_form">
               ...
               <td>
                     <span class="sp12"> <?PHP  echo (trim($info['perva_obs']) != '') ? trim($info['perva_obs']) : '-------- '; ?>   </span>
                </td>
            </tr>
                ...
                foreach($documentos as $doc){
                    ...
                    ?> 
                     <tr class="row_form2">
                         ...
                         <td align="center">
                              <a href="#" onclick="Persona.quitar_documento('<?PHP echo $doc['doc_key'] ?>','view_vacaciones');"> Quitar </a>  
                         </td>
                     </tr>  
                    <?PHP 
