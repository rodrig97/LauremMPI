...
<div id="dvViewName" class="dv_view_name">
        ...
        <table class="_tablepadding2" border="0">
          ...
          <tr> 
            ...
            <td>
                Nuevo registro de Historial laboral.
              </td>
          </tr>
      </table>
</div> 
              ...
              <form id="form_info_historial" name="form_info_historial"  data-dojo-type="dijit.form.Form">   
                     ...
                     <table class="_tablepadding4" width="100%" border="0">
                             <tr height="35" class="row_form" >
                                  ...
                                  <td width="20">:</td>
                                  <td> 
                                       <select id="selhis_laboral" name="situlaboral"  data-dojo-type="dijit.form.Select" data-dojo-props='name:"situlaboral"' class="formelement-35-12" style="width:200px;">
                             ...
                             <tr id="trhis_periodo"  height="35" class="row_form">
                                 <td> <span class="sp12b"> Inicio del Contrato </span></td>
                                  <td>:</td>
                                  <td> 
                                       ...
                                       <input id="chhis_actual" name="vigente" type="checkbox" value="1" data-dojo-type="dijit.form.CheckBox" data-dojo-props=""  />
                                         ...
                                         <input id="calhisdesde" type="text" class="formelement-100-11" data-dojo-type="dijit.form.DateTextBox"
                                                ...
                                                onChange="dijit.byId('calhistermino').constraints.min = this.get('value'); 
                                                          dijit.byId('calhistermino').set('value', this.get('value') );   "     
                                             />
                                 ...
                                 <td> <span class="sp12b"> Carnet de construcción civil </span></td>
                                  ...
                                  <td> 
                                       ...
                                       <input id="chcarnet_presento" 
                                              name="presento" 
                                              data-dojo-props="name:'carnet_presento'"
                                              type="checkbox" 
                                              value="1" 
                                         ...
                                         <div>
                                           ...
                                           <input id="calCarnetDesde" 
                                                  ...
                                                  onChange="dijit.byId('calCarnetHasta').constraints.min = this.get('value'); 
                                                            dijit.byId('calCarnetHasta').set('value', this.get('value') );   "     
                                               />
                                           ...
                                           <input id="calCarnetHasta" 
                                            ...
                                            <input type="text" data-dojo-type="dijit.form.TextBox" style="font-size:11px; width: 70px; " data-dojo-props='type:"text", name:"fechacarnet_numero"' />
                                          </div>
                             ...
                             <tr id="trhis_plaza" height="35"  class="row_form" style="display:none;">
                                  ...
                                  <td>:</td>
                                  <td> 
                                      <input type="text" name="plaza" data-dojo-type="dijit.form.TextBox" data-dojo-props="maxlength:50" class="formelement-150-12" value="."  />
                                  </td>
                             </tr>
                             ...
                             <tr id="trhis_monto" height="35"  class="row_form">
                                  ...
                                  <td>:</td>
                                  <td> 
                                      <input name="montocontrato" type="text" data-dojo-type="dijit.form.TextBox" data-dojo-props="maxlength:5" class="formelement-50-12" value="0" />
                                  </td>
                             </tr>
                             ...
                             <tr id="trhis_doc" height="35"  class="row_form">
                                  ...
                                  <td>:</td>
                                  <td> 
                                      <input name="documento" type="text" data-dojo-type="dijit.form.TextBox" data-dojo-props="maxlength:20" class="formelement-100-12" value="." />

                                      <span class="sp12b">Autoriza : </span> 

                                       <input name="autoriza" type="text" data-dojo-type="dijit.form.TextBox" data-dojo-props="maxlength:20" class="formelement-200-12" value="." /> 
                                  </td>
                             </tr>
                             ...
                             <tr> 
                              ...
                              <tr id="trhis_depe" height="35"  class="row_form"  style="display:none;">
                                  ...
                                  <td>:</td>
                                  <td> 
                                      <select name="dependencia" id="selhis_depe" data-dojo-type="dijit.form.FilteringSelect" data-dojo-props='autoComplete:false, highlightMatch: "all",  queryExpr:"*${0}*", invalidMessage: "La dependencia no existe"   ' style="width: 330px; font-size:12px;">
         ...
         <?PHP 
                           ...
                           <!--    <tr id="trhis_proy" height="35"  class="row_form"  style="display:none;">
                                  ...
                                  <td> 
                                      ...
                                      <div id="dvhis_proyecto" style="display:none;">
                                              ...
                                              <select id="selhis_proyecto" name="proyecto" data-dojo-type="dijit.form.FilteringSelect" data-dojo-props='autoComplete:false, highlightMatch: "all",  queryExpr:"*${0}*", invalidMessage: "El Proyecto no existe"   ' style="width: 330px; font-size:12px;">
                                                    ...
                                                    ?>
                                                        <option  value="<?PHP echo trim($meta['ano_eje'].'-'.$meta['sec_ejec'].'-'.$meta['sec_func']);  ?>"> <?PHP echo '(Año: '.trim($meta['ano_eje']).' - '.$meta['sec_func'].') '.trim($meta['nombre']); ?> </option>
                              ...
                              <tr id="trhis_cargo" height="35"  class="row_form"  style="display:none;">
                                  ...
                                  <td>:</td>
                                  <td> 
                                    <!--    <select name="cargo" id="selhis_cargo" data-dojo-type="dijit.form.Select" data-dojo-props='' style="width: 180px; font-size:12px;">
                                                     <option value="0" selected="selected"> NO ESPECIFICADO </option>
                                                   <?PHP 
                                ...
                                <button class="btnproac_regacti" dojoType="dijit.form.Button" class="dojobtnfs_12" > 
                                    ...
                                    ?>
                                       ...
                                       <script type="dojo/method" event="onClick" args="evt">
                                                Persona.Ui.btn_historiaregister_click(this,evt);     
                                       </script>
                                </button>
