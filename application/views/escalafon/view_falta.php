...
<div class="dv_form_bceleste"> 
    <div> 
   <input class="data" type="hidden" value="faltar-<?PHP echo trim($info['pefal_id']); ?>" />   
    <?PHP 
...
<table class="_tablepadding4" width="100%">
    ...
    <tr height="30" class="row_static_form">
     ...
     <tr height="30" class="row_static_form">
       ...
       <td>
             <span class="sp12"> <?PHP  echo _get_date_pg(trim($info['pefal_desde'])).' - '._get_date_pg(trim($info['pefal_hasta'])); ?>  </span>
        </td>
    </tr>
    
    <tr height="30" class="row_static_form">
        <td>
             <span class="sp12b">Justificada</span>
        </td>
         <td>
             <span class="sp12b">:</span>
        </td>
       <td>
             <span class="sp12"> <?PHP  echo (trim($info['pefal_justificada']) == '1') ? 'Si' : 'No';  ?>   </span>
        </td>
    </tr>
 
    <tr height="30" class="row_static_form">
        <td>
             <span class="sp12b">Justificacion</span>
        </td>
         <td>
             <span class="sp12b">:</span>
        </td>
       <td>
             <span class="sp12"> <?PHP  echo (trim($info['pefal_justificacion']) != '') ? trim($info['pefal_justificacion']) : '--------'; ?>   </span>
        </td>
    </tr>
    ...
    <tr height="30" class="row_static_form">
       ...
       <td>
             <span class="sp12"> <?PHP  echo (trim($info['pefal_observacion']) != '') ? trim($info['pefal_observacion']) : '--------'; ?>   </span>
        </td>
    </tr>
