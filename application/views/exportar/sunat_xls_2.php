<?PHP 
 ...
 //name the worksheet
 $this->excel->getActiveSheet()->setTitle('SUNAT_PORTRABAJADOR'); // 3500
 ...
 $headers = array('#', 'Apellido Paterno', 'Apellido Materno', 'Nombres', 'DNI', 'REGIMEN' );


 $this->excel->getActiveSheet()->setCellValue( 'A1', 'CONSOLIDADO SUNAT POR TRABAJADOR' );
 ...
 $POSICIONES = array('G','H','I','J','K','L','M','N','O','P','Q','R','S','T');
 $columna_indice = 0;
