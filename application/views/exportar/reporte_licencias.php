<?PHP 
 ...
 $this->excel->getActiveSheet()->setTitle($nombre_reporte); 
 ...
 $this->excel->getActiveSheet()->setCellValue( 'A1', $nombre_reporte );
...
$this->excel->getActiveSheet()->setCellValue( ('F'.$f), 'Desde' );
$this->excel->getActiveSheet()->setCellValue( ('G'.$f), 'Hasta' );
$this->excel->getActiveSheet()->setCellValue( ('H'.$f), 'Dias' );
$this->excel->getActiveSheet()->setCellValue( ('I'.$f), 'Detalle/Observacion' );
$this->excel->getActiveSheet()->setCellValue( ('J'.$f), 'Fecha Registro' );
 ...
 { 
     ...
     $this->excel->getActiveSheet()->setCellValueExplicit(
         ('I'.$f), 
         trim($reg['observacion']),
         PHPExcel_Cell_DataType::TYPE_STRING
     );   

     $this->excel->getActiveSheet()->setCellValueExplicit(
         ('J'.$f), 
         _get_date_pg(trim($reg['fecha_registro'])),
         PHPExcel_Cell_DataType::TYPE_STRING
     );   
 ...
 $sheet->setSharedStyle($sharedStyle1,'A'.$finicio.':J'.$finicio); 
 ...
 $sheet->setSharedStyle($sharedStyle2,'A'.($finicio+1).':J'.$f); 
