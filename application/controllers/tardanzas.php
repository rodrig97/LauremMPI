...
class tardanzas extends CI_Controller {
    ...
    public function __construct(){
        ...
        $this->load->library(array( 'App/persona','App/tardanza','App/documento' ));
    ...
    public function view(){
         ...
         $id= $this->tardanza->get_id($codigo);
         $info = $this->tardanza->view($id); 

         $documentos = $this->documento->get_list(FUENTETIPODOC_FALTAR, $id);

         $this->load->view('escalafon/view_tardanza', array('info' => $info, 'documentos' => $documentos));
    ...
    public function delete(){
        ...
        { 
             ...
             $id= $this->tardanza->get_id($codigo);
            // var_dump($id);
             $op = $this->tardanza->desactivar($id);
             $response =  array(
